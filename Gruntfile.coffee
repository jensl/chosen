...
"""
    ...
    copy:
      ...
      critic:
        files: [
          { src: ["public/chosen.jquery.js"], dest: "../../../src/resources/third-party/chosen.js" }
          { src: ["public/chosen.jquery.min.js"], dest: "../../../src/resources/third-party/chosen.min.js" }
          { src: ["public/chosen.css"], dest: "../../../src/resources/third-party/chosen.css" }
          { src: ["public/chosen.min.css"], dest: "../../../src/resources/third-party/chosen.min.css" }
        ]
  ...
  grunt.registerTask 'critic', ['build', 'copy:critic']
